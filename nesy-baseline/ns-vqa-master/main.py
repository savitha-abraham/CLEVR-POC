...
run = f"python ./reason/tools/sample_questions.py         --n_questions_per_family 10         --input_question_h5 {ns_vqa_root}/data/reason/{DATA_FOLDER_NAME}/clevr-poc-train_questions.h5         --output_dir {ns_vqa_root}/data/reason/{DATA_FOLDER_NAME}" 
get_ipython().system('{run} ')
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
path_plot = os.path.join(ns_vqa_root, 'data/reason', DATA_FOLDER_NAME,'pretrain-plot_10S_200E.png')
