...
run = f"python ./reason/tools/sample_questions.py         --n_questions_per_family 80         --input_question_h5 {ns_vqa_root}/data/reason/{DATA_FOLDER_NAME}/clevr-poc-train_questions.h5         --output_dir {ns_vqa_root}/data/reason/{DATA_FOLDER_NAME}" 
get_ipython().system('{run} ')
