...
run = f"python ./reason/tools/sample_questions.py         --n_questions_per_family 100         --input_question_h5 {ns_vqa_root}/data/reason/{DATA_FOLDER_NAME}/clevr-poc-train_questions.h5         --output_dir {ns_vqa_root}/data/reason/{DATA_FOLDER_NAME}" 
get_ipython().system('{run} ')
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
path_plot = os.path.join(ns_vqa_root, 'data/reason', DATA_FOLDER_NAME,'pretrain-plot_40S_100E.png')
...
#TESTING
run = f"python ./reason/tools/run_test.py         --main_root={main_root}         --ns_vqa_root={ns_vqa_root}         --data_folder_name={DATA_FOLDER_NAME}         --clevr_val_scene_path {main_root}/clevr-poc-dataset-gen/{DATA_FOLDER_NAME}/incomplete/scenes/validation       --clevr_val_question_path {ns_vqa_root}/data/reason/{DATA_FOLDER_NAME}/clevr-poc-val_questions.h5         --clevr_constraint_scene_path {main_root}/clevr-poc-dataset-gen/environment_constraints         --load_checkpoint_path {ns_vqa_root}/data/reason/{DATA_FOLDER_NAME}/model_pretrain/checkpoint_best_40.pt         --save_result_path {ns_vqa_root}/data/reason/{DATA_FOLDER_NAME}/test_result.json         --clevr_vocab_path {ns_vqa_root}/data/reason/{DATA_FOLDER_NAME}/clevr-poc-vocab.json"
get_ipython().system('{run} ')
