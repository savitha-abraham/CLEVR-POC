...
def main(args):
  ...
  constraints_types_list = get_constraint_types()
  ...
  num_image_per_constraint_type = [0 for i in range(len(constraints_types_list))]
  max_number_of_constraints_per_image = math.floor(args.num_images/len(constraints_types_list))
  ...
  #for i in range(args.num_images):
    ...
    constraint_type_index = select_constraint_type(constraints_types_list, num_image_per_constraint_type, max_number_of_constraints_per_image)
